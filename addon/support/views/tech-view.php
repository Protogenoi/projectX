<div class="panel panel-primary">
    <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-ticket-alt"></i> Tech To Do</h3>
    </div>
    <div class="panel-body">
        ...
        <table class="table table-condensed">
            ...
            if ($techSupportTickets != 'error') {

                foreach ($techSupportTickets as $rows):
                    ...
                    <tr>
                        ...
                        <td><?php echo $supportName; ?> <span id="myTechText<?php echo $rows['id']; ?>"
                        ...
                        <script>
                            ...
                            document.getElementById("myTechText<?php echo $rows['id']; ?>").innerHTML = "(" + time + ")";
                        </script>
                        <td>
                                        <span
