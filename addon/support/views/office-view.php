<div class="panel panel-primary">
    <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-ticket-alt"></i> Office To do</h3>
    </div>
    <div class="panel-body">
        ...
        <table class="table table-condensed">
            ...
            if ($officeSupportTickets != 'error') {

                foreach ($officeSupportTickets as $rows):
                    ...
                    <tr>
                        ...
                        <td><?php echo $supportName; ?> <span id="myOfficeText<?php echo $rows['id']; ?>"
                        ...
                        <script>
                            ...
                            document.getElementById("myOfficeText<?php echo $rows['id']; ?>").innerHTML = "(" + time + ")";
                        </script>
                        <td>
                                        <span
