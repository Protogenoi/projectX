<div class="panel panel-primary">
    <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-ticket-alt"></i> All To Do</h3>
    </div>
    <div class="panel-body">
        ...
        <table class="table table-condensed">
            ...
            if ($supportTickets != 'error') {

                foreach ($supportTickets as $rows):
                    ...
                    <tr>
                        ...
                        <td><?php echo $supportName; ?> <span id="myText<?php echo $rows['id']; ?>"
                        ...
                        <script>
                            ...
                            document.getElementById("myText<?php echo $rows['id']; ?>").innerHTML = "(" + time + ")";
                        </script>
                        <td>
                                        <span
