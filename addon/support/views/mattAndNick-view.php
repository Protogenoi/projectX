<div class="panel panel-primary">
    <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-ticket-alt"></i> Matt & Nick To Do</h3>
    </div>
    <div class="panel-body">
        ...
        <table class="table table-condensed">
            ...
            if ($mattAndNickTickets != 'error') {

                foreach ($mattAndNickTickets as $rows):
                    ...
                    <tr>
                        ...
                        <td><?php echo $supportName; ?> <span id="myTechExtText<?php echo $rows['id']; ?>"
                        ...
                        <script>
                            ...
                            document.getElementById("myTechExtText<?php echo $rows['id']; ?>").innerHTML = "(" + time + ")";
                        </script>
                        <td>
                                        <span
