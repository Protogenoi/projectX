...
abstract class ServiceOptions
{
    ...
    public static function update(
        ...
        $mediaCompatibilityMessage = Values::NONE,
        $preWebhookRetryCount = Values::NONE,
        $postWebhookRetryCount = Values::NONE,
        $notificationsLogEnabled = Values::NONE
    ) {
