...
class TemplatesTest extends BaseTestClass
{
  ...
  "template_id": "ddb96bbc-9b92-425e-8979-99464621b543"
        ...
        $template_id = "test_url_param";
        $request_headers = ["X-Mock: 201"];
        $response = self::$sg->client->templates()->_($template_id)->versions()->post($request_body, null,
            $request_headers);
        $this->assertEquals(201, $response->statusCode());
    }
  ...
  "subject": "<%subject%>"
    ...
    public function testTemplatesIdVersionsIdGetMethod()
    {
        ...
        $version_id = "test_url_param";
        $request_headers = ["X-Mock: 200"];
        $response = self::$sg->client->templates()->_($template_id)->versions()->_($version_id)->get(null, null,
            $request_headers);
        $this->assertEquals(200, $response->statusCode());
    }
