...
class TrackingSettingsTest extends BaseTestClass
{
  ...
  "utm_term": ""
        ...
        $request_headers = ["X-Mock: 200"];
        $response = self::$sg->client->tracking_settings()->google_analytics()->patch($request_body, null,
            $request_headers);
        $this->assertEquals(200, $response->statusCode());
    }
  ...
  "url": "url"
        ...
        $request_headers = ["X-Mock: 200"];
        $response = self::$sg->client->tracking_settings()->subscription()->patch($request_body, null,
            $request_headers);
        $this->assertEquals(200, $response->statusCode());
    }
